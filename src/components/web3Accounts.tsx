...
export default function Web3Accounts() {
    ...
    return (<div>
        <div> web3-eth-accounts package
            <div> web3-eth-accountsCreate method loading time: {loadTimeAccountsCreate}</div>
            <div> web3 main packageCreate method loading time: {loadTimeWeb3AccountsCreate}</div>
        </div>
        </div>);
};